...
>
  <head>
    ...
    <title>Konfirmasi Registrasi | <?php echo $s0['nama_toko']; ?></title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            ...
            <?php
              ...
              <form id="formAuthentication" class="mb-3" action="http://localhost/go-app/confirmotpreg" method="POST">
                <div class="mb-3">
                  <input
                    type="hidden"
                    class="form-control"
              ...
              <a href="http://localhost/go-app/resendotpreg?token=<?php echo $_GET['token']; ?>" class="btn btn-danger btn-block">Kirim Ulang OTP</a>
