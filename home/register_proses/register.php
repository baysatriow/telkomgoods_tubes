...
?>
<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="assets/admin/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
    <title>Registrasi | <?php echo $s0['nama_toko']; ?></title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            ...
            <?php
              ...
              if (!empty($_GET['notif'])) {
                  ...
                  if ($_GET['notif'] == 8) {
                      echo "
                          iziToast.warning({
                              title: 'Perhatian!',
                              message: 'Username atau No HP sudah ada!',
                              position: 'topRight'
                          });
                      ";
                  }
              ...
              <p class="mb-4">Silahkan daftar untuk menggunakan aplikasi</p>
              <form id="formAuthentication" class="mb-3" action="http://localhost/go-app/registerproses" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                  <label for="fullname" class="form-label">Nama Lengkap</label>
                  <input type="text" class="form-control" id="fullname" name="name" placeholder="Masukkan nama lengkap Anda" autofocus />
                </div>
                <div class="mb-3">
